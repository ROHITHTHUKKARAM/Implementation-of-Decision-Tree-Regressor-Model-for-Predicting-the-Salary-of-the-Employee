...
*/
import pandas as pd
data=pd.read_csv("/Users/admin/Downloads/Salary.csv")
data.head()
data.info()
data.isnull().sum()
...
## Output:
![Screenshot 2024-10-07 113656](https://github.com/user-attachments/assets/bcc9cfec-f86a-481c-83e3-cdef3d78f89f)
![Screenshot 2024-10-07 113726](https://github.com/user-attachments/assets/141e89f1-a247-4c42-a568-581a32767649)
